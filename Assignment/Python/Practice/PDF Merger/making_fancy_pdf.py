...
class FancyPDF(FPDF):
    def header(self):
        ...
        self.set_text_color(40, 40, 120)  # Dark Blue
    ...
    def add_table(self, col_widths, headings, data):
        ...
        for i, heading in enumerate(headings):
            self.cell(col_widths[i], 10, heading, border=1, align='C', fill=True)
        self.ln()
...
data = [
    ...
    ["a = b = c = 10", "10", "Assignment Right to Left"]
]
...
data = [
    ...
    ["Associativity", "Mostly Left-to-Right, some Right-to-Left"]
]
col_widths = [70, 120]
pdf.add_table(col_widths, headings, data)

# Output file
pdf.output("Python_TypeConversion_Precedence_Associativity_Fancy.pdf")

print("✅ PDF created successfully as 'Python_TypeConversion_Precedence_Associativity_Fancy.pdf'")
